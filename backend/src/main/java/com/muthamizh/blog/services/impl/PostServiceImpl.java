...
import com.muthamizh.blog.repositories.PostRepository;
import com.muthamizh.blog.services.CategoryService;
import com.muthamizh.blog.services.PostService;
...
public class PostServiceImpl implements PostService {
    ...
    public Post createPost(User user, CreatePostRequest createPostRequest) {
        ...
        newPost.setReadingTime(calcuateReadingTime(createPostRequest.getContent()));
    ...
    public Post updatePost(UUID id, UpdatePostRequest updatePostRequest) {
        ...
        existingPost.setReadingTime(calcuateReadingTime(postContent));
    ...
    private Integer calcuateReadingTime(String content)
    {
